                     ...
                     <div class="navbar-inner"> 
                         <div class="nav-collapse nav-collapse_ collapse" style="margin-left: 150px">
                            <ul class="sf-menu">
                                ...
                                <li class="active"><a href="adminFileDetails.jsp"><div class="base_text">View File Details</div><div class="over"></div></a></li>
        ...
        <br><br><div class="section_01_left" style="margin-left: 060px; width: 70%">
            <div style="width: 1000px;height: 400px;margin-left: 120px;border: solid 1px;border-color: whitesmoke;border-radius: 3px">
                <br><table  style=" margin-left: 30px;width:70%;position:absolute;">
                    <tr align="center" style="background-color: white;border-radius: 3px;color:red;font-family:verdana;font-size:14px;font-weight: bold">
                                ...
                                <%
                                    String host = null, name = null, pass = null, fid = null, pdfass = null, mobile = null, gen = null, blood = null, dis = null, zip = null;
                                    Connection con = null;
                                ...
                                <tr align="center" style="font-family:verdana;font-size:14px;"> 
                                    <td height="25"> <font color="#5eaaff"><%=host%></font> </td>
