...
<body>
                     ...
                     <div class="navbar-inner"> 
                         <div class="nav-collapse nav-collapse_ collapse" style="margin-left: 010px">
                            <ul class="sf-menu">
                                ...
                                <li class="active"><a href="FileDownload.jsp"><div class="base_text">File Download</div><div class="over"></div></a></li>
    ...
    <!-- content -->
    <div style="width: 100%; height: 500px;background-image: url('img/bg2.jpg')">
        <br><br><div class="section_01_left" style="margin-left: 550px;">
                <div class="section_01_left" style="width: 500px;height: 400px;margin-left: -140px;border: solid 1px;border-color: white;border-radius: 3px">
                    <br><center><p style="color: white;font-family: monospace;font-size: 20px;font-weight: bold;">Download Here </p></center><br>
                <table  style=" margin-left: 50px;width:30%;position:absolute;">
                    <tr align="center" style="background-color: white;border-radius: 3px;color:red;font-family:verdana;font-size:12px;font-weight: bold">
                                ...
                                <tr align="center" style="font-family:verdana;font-size:14px;"> 
                                    ...
                                    <td> <font color="#5eaaff"><a href="download.jsp?<%=host%>">Get it!!</a></font> </td>
                                </tr>
                                    <%
                                            }
