...
<body>
                     ...
                     <div class="navbar-inner"> 
                         <div class="nav-collapse nav-collapse_ collapse" style="margin-left: 150px">
                            <ul class="sf-menu">
                                ...
                                <li><a href="group_details.jsp"><div class="base_text">View Group</div><div class="over"></div></a></li>
                                <li class="active"><a href="log_details.jsp"><div class="base_text">View Log Details</div><div class="over"></div></a></li>
    ...
    <div style="width: 100%; height: 500px;background-image: url('img/banhm.jpg')">
        <br><br><div class="section_01_left" style="margin-left: 060px; width: 70%">
            <div style="width: 1000px;height: 400px;margin-left: 120px;border: solid 1px;border-color: whitesmoke;border-radius: 3px">
                <br><table  style=" margin-left: 30px;width:70%;position:absolute;">
                    <tr align="center" style="border-radius: 20px;background-color: white;color:red;font-family:verdana;font-size:14px;font-weight: bold">
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        String query1 = "select * from log_details";//+"'";//'"+session.getAttribute("uID").toString() +"'";// "+" AND email = '"+mail+"' ";
                                        ResultSet rs = st.executeQuery(query1);

                                        while (rs.next()) {

                                            host = rs.getString("user_id");
                                ...
                                %>
                                <tr align="center" style="font-family:verdana;font-size:14px;height:26px"> 
                                    <td height="36"> <font color="#5eaaff"><%=host%></font> </td>
                                    <td> <font color="#5eaaff"><%=name%></font> </td>
                                    <td> <font color="#5eaaff"><%=group%></font> </td>
                                    <td> <font color="#5eaaff"><%=status%></font> </td>
                                    <td> <font color="#5eaaff"><%=date%></font> </td>
                                </tr>
                                    <%
                                            }
                                        } catch (Exception e) {
