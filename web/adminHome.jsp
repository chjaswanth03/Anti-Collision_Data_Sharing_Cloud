...
<body>
            ...
            <div class="container">
                ...
                <div class="navbar">
                     <div class="navbar-inner"> 
                         <div class="nav-collapse nav-collapse_ collapse" style="margin-left: 90px">
                            <ul class="sf-menu">
                                <li class="active"><a href="adminHome.jsp"><div class="base_text">Home</div><div class="over"></div></a></li>
    ...
    <!-- content -->
    <div style="width: 100%; height: 500px;background-image: url('img/cld4.jpg')">
