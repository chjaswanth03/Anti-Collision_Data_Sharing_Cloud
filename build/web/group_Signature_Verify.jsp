...
<body>
                     ...
                     <div class="navbar-inner"> 
                         <div class="nav-collapse nav-collapse_ collapse" style="margin-left: 200px">
                            <ul class="sf-menu">
                                ...
                                <li class="active"><a href="member_login.jsp"><div class="base_text">Group Members</div><div class="over"></div></a></li>
                                <li><a href="register.jsp"><div class="base_text">Registration</div><div class="over"></div></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div style="width: 100%; height: 500px;background-image: url('img/banhm.jpg')">
        <br><br><div class="section_01_left" style="margin-left: 550px;">
            <div style="border:solid 2px;border-radius: 9px;border-color: white;height: 300px;width: 350px;padding: 50px;margin-left: -120px;">
                <p style="font-family: monospace; font-size: xx-large;color: white">Signature Verification</p>
                <div>
                   <form action ="sigVerify" method="get">
                        <p style="font-family: fantasy;color: white;font-size: 15px">Insert Signature Here</p>
                        <p><input type="text" name="sig" style="height:25px;width:220px;"/></p>
                        
                        <p></p>
                        <p ><input type="submit" value="Submit" style="height:25px;width:100px;font-family: cursive" /> <input type="reset" value="Reset" style="height:25px;width:100px;font-family: cursive" /></p>
