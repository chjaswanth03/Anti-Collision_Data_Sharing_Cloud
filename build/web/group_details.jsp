...
<body>
    ...
    <div style="width: 100%; height: 500px;background-image: url('img/banhm.jpg')">
        <br><br><div class="section_01_left" style="margin-left: 50px;">
            <center>
                <form action="view_Action.jsp" method="get">
                <p style="font-family: cursive; font-size:30px;color:white">Choose the Respective Group<br><br><br><br>
                    
                <select id="keys" name="group" style="width: 220px; height: 30px;font-family:fantasy"> 
                ...
                </select>&nbsp;&nbsp;&nbsp;<br><br><br><input type="submit" value="View" style="width:80px; height: 30px;font-family:cursive" /> </p> 
                </form>
            </center>
            </div>  
    </div>
