...
<html lang="en">
    ...
    <body>
        <div style="height: 600px;background-color: white">
                    ...
                    <div class="container">
                        ...
                        <div class="navbar">
                            <div class="navbar-inner"> 
                                <div class="nav-collapse nav-collapse_ collapse" style="margin-left: 000px">
                                    <ul class="sf-menu">
                                        <li><a href="memberHome.jsp"><div class="base_text">Home</div><div class="over"></div></a></li>
                                        <li class="active"><a href="file_upload.jsp"><div class="base_text">File Upload</div><div class="over"></div></a></li>
            ...
            <!-- content -->
            <div style="width: 100%; height: 500px;background-image: url('img/cld1.jpg')">
                <br><br><div class="section_01_left" style="margin-left: 550px;">
                    <div style="border:solid 2px;border-radius: 9px;border-color: white;height: 300px;width: 400px;padding: 50px;margin-left: -120px;">
                        <p style="font-family: monospace; font-size: xx-large;font-weight: bold;color: darkblue">Upload your Files to cloud</p><br><br>
                        <div><center>
                                <form name="" action="upload" method="post" enctype="multipart/form-data">
                                    <p style="font-size: 20px;color: darkblue;font-weight: bold;"><< Upload Here >></p><br>
                                    <input style="margin-left: 155px;" name="file" type="file" id="file"/><br><br>
                                    <input type="submit" value="Upload" style="height: 30px;width: 90px;"/>
                                </form>
                            </center>
